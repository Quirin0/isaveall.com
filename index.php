...
<form class="form pb-2" name="formurl" method="post" action="">
  ...
  <div class="is-relative" style="overflow: hidden;width: 100%;">
    <input name="url" id="link" type="text" class="link-input" value="" placeholder="Paste ( Tiktok, Instagram, Facebook )" required="" aria-label="Name" autocomplete="off" autocapitalize="none">
...
<section class="container mt-1">
  <h5 class="text-center font-weight-600">How to Use iSaveAll Video Downloader</h5>
  <div class="row text-left" style="margin: 0 0 35px 0;">
    <div class="col-md-4 mt-4 mx-0 pr-md-4">
      <h2 style="font-weight: 600;">Find the link of media you want</h2>
    ...
    <div class="col-md-4 mt-4 mx-0">
      <h2 style="font-weight: 600;">Paste the video URL</h2>
    ...
    <div class="col-md-4 mt-4 mx-0 pl-md-4">
      <h2 style="font-weight: 600;">Download the Video or Audio</h2>
...
<div class="accordion" id="faq" itemscope="" itemtype="https://schema.org/FAQPage">
  <div class="accordion-item">
    <h2 class="accordion-header" id="hd1">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#chd1" aria-expanded="false" aria-controls="chd1">
        How to Download Tiktok Video Without Watermark?
      </button>
    </h2>
    <div id="chd1" class="accordion-collapse collapse " aria-labelledby="hd1" data-bs-parent="#accordionExample">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="hd2">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#chd2" aria-expanded="false" aria-controls="chd2">
        How to get the TikTok Video Download Link?
      </button>
    </h2>
    <div id="chd2" class="accordion-collapse collapse" aria-labelledby="hd2" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <ul class="list-unstyled">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="hd5">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#chd5" aria-expanded="false" aria-controls="chd5">
        Is the service provided by this site free?
      </button>
    </h2>
    <div id="chd5" class="accordion-collapse collapse" aria-labelledby="hd5" data-bs-parent="#accordionExample">
      <div class="accordion-body">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="hd6">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#chd6" aria-expanded="false" aria-controls="chd6">
        Is there a limitation on the numbers of videos downloaded?
      </button>
    </h2>
    <div id="chd6" class="accordion-collapse collapse" aria-labelledby="hd6" data-bs-parent="#accordionExample">
      <div class="accordion-body">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="hd7">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#chd7" aria-expanded="false" aria-controls="chd7">
        Which devices are suported?
      </button>
    </h2>
    <div id="chd7" class="accordion-collapse collapse" aria-labelledby="hd7" data-bs-parent="#accordionExample">
      <div class="accordion-body">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="hd8">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#chd8" aria-expanded="false" aria-controls="chd8">
        How to get the Instagram Video or Image Download Link?
      </button>
    </h2>
    <div id="chd8" class="accordion-collapse collapse" aria-labelledby="hd8" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <ul class="list-unstyled">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="hd9">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#chd9" aria-expanded="false" aria-controls="chd9">
      Can i download high definition resolution videos at iSaveAll ?
      </button>
    </h2>
    <div id="chd9" class="accordion-collapse collapse" aria-labelledby="hd9" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <ul class="list-unstyled">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="hd10">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#chd10" aria-expanded="false" aria-controls="chd10">
      Does iSaveAll support downloading multiple videos / Download all videos from a certain tiktok / Htags channel?
      </button>
    </h2>
    <div id="chd10" class="accordion-collapse collapse" aria-labelledby="hd9" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <ul class="list-unstyled">
          <li>No, iSaveAll does not support this feature yet.</li>
        </ul>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    <h2 class="accordion-header" id="hd11">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#chd11" aria-expanded="false" aria-controls="chd11">
      Can I edit TikTok videos downloaded at iSaveAll?
      </button>
    </h2>
    <div id="chd11" class="accordion-collapse collapse" aria-labelledby="hd11" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <ul class="list-unstyled">
          <li>No, iSaveAll is just a hub video downloader, not supporting video editing. Use specialized video editing software on your phone or PC</li>
        </ul>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    <h2 class="accordion-header" id="hd12">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#chd12" aria-expanded="false" aria-controls="chd12">
      Does SnapTik provide tiktok mp3 download solution?
      </button>
    </h2>
    <div id="chd12" class="accordion-collapse collapse" aria-labelledby="hd12" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <ul class="list-unstyled">
          <li>iSaveAll respects the intellectual property rights of the tracks so iSaveAll will not provide this solution. However, there are currently quite a few application websites that provide this Tiktok Mp3 service such as Tikmate, SaveTik.Net, SSStiktok, etc. You can download TikTok mp3 music but are not allowed to use it for commercial activities, monetize it.</li>
        </ul>
      </div>
    </div>
  </div>
...
<p><b>Note:</b> iSaveAll (<i>Tiktok video Downloader</i>) is not a tool of Tiktok, Instagram or Facebook we have no relationship with Tiktok or ByteDance Ltd. We only support users to download our videos on Tiktok without logo without any trouble, Facebook or Instagram If you have problems with sites like Tikmate or SSSTiktok, try iSaveAll, we are constantly updating to make it easy for users to download videos. Thank you!</p>
</div>
</div>
</div>
</div>
